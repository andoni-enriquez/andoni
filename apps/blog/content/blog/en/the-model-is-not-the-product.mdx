...
<mark>
  The problem is not generating the explanation. The problem is verifying the
  employee understood it — and ensuring that understanding persists.
</mark>
...
<mark>
  The moat is not the model. The moat is everything the model needs to actually
  work.
</mark>

The data on what actually produces competence in real workplaces.
That data compounds with every company we touch. It doesn't
exist anywhere else.
...
We're doing that for enterprise. Same depth, different domain. You'll see it
soon.

---

The big labs won't replace us.
